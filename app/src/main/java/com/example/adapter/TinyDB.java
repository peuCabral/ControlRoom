...
public class TinyDB {
    ...
    public ArrayList<SalaModel> getListSalaObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<SalaModel> objects =  new ArrayList<SalaModel>();

        for(String jObjString : objStrings){
            SalaModel value  = gson.fromJson(jObjString,  SalaModel.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void  putListSalaObject(String key, ArrayList<SalaModel> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
